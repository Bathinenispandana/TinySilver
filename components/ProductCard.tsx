  ...
  return (
    <div className="group relative flex flex-col">
      ...
      <Link
        ...
        className="relative block aspect-[4/5] w-[70%] sm:w-[88%] mx-auto overflow-hidden rounded-xl bg-[#f5f5f6] border border-transparent group-hover:border-[#c5c6cc] transition-all duration-300"
      >
        <Image
          src={product.image}
          alt={product.name}
          fill
          sizes="(max-width: 640px) 84vw, (max-width: 768px) 44vw, (max-width: 1200px) 28vw, 21vw"
      ...
      {/* PRODUCT DETAILS */}
      <div className="mt-3 flex flex-col gap-1 px-[8%] sm:px-[6%]">
